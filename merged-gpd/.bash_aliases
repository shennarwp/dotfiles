...
# --- Alpine (apk) overrides: apt-based uu/uug replaced -----------------------
alias uu='sudo apk update && sudo apk upgrade'
alias uug='sudo apk update && sudo apk upgrade'
alias aai='sudo apk add'
alias aas='sudo apk search'
